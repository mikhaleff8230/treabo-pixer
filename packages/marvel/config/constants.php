...
if (!defined('SUBSCRIPTION_EXPIRED')) define('SUBSCRIPTION_EXPIRED', APP_NOTICE_DOMAIN . 'ERROR.SUBSCRIPTION_EXPIRED');
if (!defined('NOT_A_FREE_PRODUCT')) define('NOT_A_FREE_PRODUCT', APP_NOTICE_DOMAIN . 'ERROR.NOT_A_FREE_PRODUCT');
...
if (!defined('FULL_PATH_TO_THE_CONFIG_FILE')) define('FULL_PATH_TO_THE_CONFIG_FILE', config('shop.bitpay.config_file.json'));
